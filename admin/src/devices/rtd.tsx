...
import { RTDConfig } from '../../../src/devices/rtd';
import Switch from '@material-ui/core/Switch';

class RTD extends EzoBase<RTDConfig> {
    
    private calibrateVal: number;

    constructor(props: DeviceProps<RTDConfig>) {
        super(props); 
        
        let config: RTDConfig;
    ...
    protected handleCalibration(calibrationtype: string, tempValue: number) : boolean {
        try{
        ...
        return (
            <>
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} sm={12} md={12}>
                        <label >{I18n.t('RTD Sensor Calibration')}</label>
                    </Grid>
